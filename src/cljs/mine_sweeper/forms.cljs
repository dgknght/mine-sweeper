(ns mine-sweeper.forms
  (:require [reagent.core :as r]
            [clojure.string :as string]
            [goog.string :as gstr]
            #_[cljs-time.core :as t]
            #_[cljs-time.format :as tf]
            #_[mine-sweeper.html :refer [key-code
                                         ctrl-key?]]
            [mine-sweeper.util :as util]
            [mine-sweeper.bootstrap :as bs]
            #_[mine-sweeper.calendar :as cal]
            #_[mine-sweeper.views.calendar :as calview]
            #_[mine-sweeper.inflection :refer [humanize]]))
...
#_(def ^:private date-input-defaults
